...
describe('IncidentsController', () => {
  ...
  describe('getListIncidentResponseNarrativeRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getListIncidentResponseNarrativeRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedResponseNarrativeEntity(data)),
          );

        const result = await controller.getListIncidentResponseNarrativeRecord(
          req,
          idPathParams,
          res,
          filterQueryParams,
  ...
  describe('getSingleIncidentResponseNarrativeRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getSingleIncidentResponseNarrativeRecord')
          .mockReturnValueOnce(
            Promise.resolve(new ResponseNarrativeEntity(data)),
          );

        const result =
          await controller.getSingleIncidentResponseNarrativeRecord(
            req,
            idPathParams,
            res,
          );
  ...
  describe('getListIncidentCallInformationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getListIncidentCallInformationRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedCallInformationEntity(data)),
          );

        const result = await controller.getListIncidentCallInformationRecord(
          req,
          idPathParams,
          res,
          filterQueryParams,
  ...
  describe('getSingleIncidentCallInformationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getSingleIncidentCallInformationRecord')
          .mockReturnValueOnce(
            Promise.resolve(new CallInformationEntity(data)),
          );

        const result = await controller.getSingleIncidentCallInformationRecord(
          req,
          idPathParams,
          res,
        );
  ...
  describe('getListIncidentAdditionalInformationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getListIncidentAdditionalInformationRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedAdditionalInformationEntity(data)),
          );

        const result =
          await controller.getListIncidentAdditionalInformationRecord(
            req,
            idPathParams,
            res,
            filterQueryParams,
    ...
    it.each([
      ...
      async (data, idPathParams) => {
        const incidentsServiceSpy = jest
          .spyOn(
            incidentsService,
            'getSingleIncidentAdditionalInformationRecord',
          )
          .mockReturnValueOnce(
        ...
        const result =
          await controller.getSingleIncidentAdditionalInformationRecord(
            req,
            idPathParams,
            res,
          );
  ...
  describe('postSingleIncidentContactLanguagesRecord tests', () => {
    it.each([
      ...
      async (body, idPathParams, idir, data) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'postSingleIncidentContactLanguagesRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedContactLanguagesEntity(data)),
          );

        const result =
          await controller.postSingleIncidentContactLanguagesRecord(
            getMockReq({ headers: { [idirUsernameHeaderField]: idir } }),
            body,
            idPathParams,
          );
  ...
  describe('getListIncidentContactEducationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getListIncidentContactEducationRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedContactEducationEntity(data)),
          );

        const result = await controller.getListIncidentContactEducationRecord(
          req,
          idPathParams,
          res,
          filterQueryParams,
  ...
  describe('getSingleIncidentContactEducationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getSingleIncidentContactEducationRecord')
          .mockReturnValueOnce(
            Promise.resolve(new ContactEducationEntity(data)),
          );

        const result = await controller.getSingleIncidentContactEducationRecord(
          req,
          idPathParams,
          res,
        );
  ...
  describe('postSingleIncidentContactEducationRecord tests', () => {
    it.each([
      ...
      async (body, idPathParams, idir, data) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'postSingleIncidentContactEducationRecord')
          .mockReturnValueOnce(
            Promise.resolve(new ContactEducationEntity(data)),
          );

        const result =
          await controller.postSingleIncidentContactEducationRecord(
            getMockReq({ headers: { [idirUsernameHeaderField]: idir } }),
            body,
            idPathParams,
          );
  ...
  describe('getListIncidentContactLegalAuthorityRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'getListIncidentContactLegalAuthorityRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedContactLegalAuthorityEntity(data)),
          );

        const result =
          await controller.getListIncidentContactLegalAuthorityRecord(
            req,
            idPathParams,
            res,
            filterQueryParams,
    ...
    it.each([
      ...
      async (data, idPathParams) => {
        const incidentsServiceSpy = jest
          .spyOn(
            incidentsService,
            'getSingleIncidentContactLegalAuthorityRecord',
          )
          .mockReturnValueOnce(
        ...
        const result =
          await controller.getSingleIncidentContactLegalAuthorityRecord(
            req,
            idPathParams,
            res,
          );
  ...
  describe('postSingleIncidentActivityPlanRecord tests', () => {
    it.each([
      [
        {
          Status: 'Open',
      ...
      async (body, idPathParams, idir, data) => {
        const incidentsServiceSpy = jest
          .spyOn(incidentsService, 'postSingleIncidentActivityPlanRecord')
          .mockReturnValueOnce(Promise.resolve(new ActivityPlanEntity(data)));

        const result = await controller.postSingleIncidentActivityPlanRecord(
          getMockReq({ headers: { [idirUsernameHeaderField]: idir } }),
          body,
          idPathParams,
        );
