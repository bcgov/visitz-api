...
describe('CasesService', () => {
  ...
  describe('postSingleCaseSupportNetworkRecord tests', () => {
    it.each([
      ...
      async (body, idir, idPathParams, data) => {
        ...
        const result = await service.postSingleCaseSupportNetworkRecord(
          body,
          idir,
          idPathParams,
        );
  ...
  describe('getListCaseContactLanguagesRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        ...
        const result = await service.getListCaseContactLanguagesRecord(
          idPathParams,
          res,
          'idir',
          filterQueryParams,
  ...
  describe('getSingleCaseContactLanguagesRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        ...
        const result = await service.getSingleCaseContactLanguagesRecord(
          idPathParams,
          res,
          'idir',
        );
  ...
  describe('postSingleCaseContactLanguagesRecord tests', () => {
    it.each([
      ...
      async (body, idir, idPathParams, data) => {
        ...
        const result = await service.postSingleCaseContactLanguagesRecord(
          body,
          idir,
          idPathParams,
        );
  ...
  describe('getListCaseContactMedicalBehavioralRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        ...
        const result = await service.getListCaseContactMedicalBehavioralRecord(
          idPathParams,
          res,
          'idir',
          filterQueryParams,
  ...
  describe('getSingleCaseContactMedicalBehavioralRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        ...
        const result =
          await service.getSingleCaseContactMedicalBehavioralRecord(
            idPathParams,
            res,
            'idir',
          );
  ...
  describe('postSingleCaseContactMedicalBehavioralRecord tests', () => {
    it.each([
      ...
      'should return nested values given good input',
      async (body, idir, idPathParams, data) => {
        const contactMedicalBehavioralSpy = jest
          .spyOn(contactsService, 'postSingleContactMedicalBehavioralRecord')
          .mockReturnValueOnce(
            Promise.resolve(new NestedContactMedicalBehavioralEntity(data)),
          );

        const result =
          await service.postSingleCaseContactMedicalBehavioralRecord(
            body,
            idir,
            idPathParams,
          );
        expect(contactMedicalBehavioralSpy).toHaveBeenCalledTimes(1);
        expect(result).toEqual(new NestedContactMedicalBehavioralEntity(data));
      },
    );
  });
  ...
  describe('getListCaseContactEducationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        ...
        const result = await service.getListCaseContactEducationRecord(
          idPathParams,
          res,
          'idir',
          filterQueryParams,
  ...
  describe('getSingleCaseContactEducationRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        ...
        const result = await service.getSingleCaseContactEducationRecord(
          idPathParams,
          res,
          'idir',
        );
  ...
  describe('postSingleCaseContactEducationRecord tests', () => {
    it.each([
      ...
      async (body, idir, idPathParams, data) => {
        ...
        const result = await service.postSingleCaseContactEducationRecord(
          body,
          idir,
          idPathParams,
        );
  ...
  describe('getListCaseContactLegalAuthorityRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        ...
        const result = await service.getListCaseContactLegalAuthorityRecord(
          idPathParams,
          res,
          'idir',
          filterQueryParams,
  ...
  describe('getSingleCaseContactLegalAuthorityRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        ...
        const result = await service.getSingleCaseContactLegalAuthorityRecord(
          idPathParams,
          res,
          'idir',
        );
  ...
  describe('getListCaseActivityPlanRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams, filterQueryParams) => {
        ...
        const result = await service.getListCaseActivityPlanRecord(
          idPathParams,
          res,
          'idir',
          filterQueryParams,
  ...
  describe('getSingleCaseActivityPlanRecord tests', () => {
    it.each([
      ...
      async (data, idPathParams) => {
        ...
        const result = await service.getSingleCaseActivityPlanRecord(
          idPathParams,
          res,
          'idir',
        );
  ...
  describe('postSingleCaseActivityPlanRecord tests', () => {
    it.each([
      ...
      async (body, idir, idPathParams, data) => {
        ...
        const result = await service.postSingleCaseActivityPlanRecord(
          body,
          idir,
          idPathParams,
        );
