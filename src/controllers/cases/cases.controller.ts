...
/*
	Note: The functions for getting multiple cases (/cases) and a single 
	case by id (/case/:id)
...
export class CasesController {
  ...
  @ApiOperation({
    description:
      'Create a support network record related to the given case id.',
  })
  @ApiCreatedResponse({
    content: {
      [CONTENT_TYPE]: {
        examples: {
          SupportNetworkCreatedResponse: {
            value: PostSupportNetworkCaseResponseExample,
          },
        },
      },
    },
  ...
  async postSingleCaseSupportNetworkRecord(
    ...
    return await this.casesService.postSingleCaseSupportNetworkRecord(
      supportNetworkDto,
      req.headers[idirUsernameHeaderField] as string,
      id,
    );
  ...
  @ApiOperation({
    description:
      'Find all Contact Language entries related to a given Case and contact entity by Case and contact id.',
  })
  @ApiQuery({ name: afterParamName, required: false })
  @ApiQuery({ name: recordCountNeededParamName, required: false })
  @ApiQuery({ name: pageSizeParamName, required: false })
  ...
  async getListCaseContactLanguagesRecord(
    ...
    return await this.casesService.getListCaseContactLanguagesRecord(
      id,
      res,
      req.headers[idirUsernameHeaderField] as string,
      filter,
  ...
  @ApiOperation({
    description: `Displays the single ${contactLanguageIdName} result if it is related to the given Case and contact id.`,
  })
  ...
  async getSingleCaseContactLanguagesRecord(
    ...
    return await this.casesService.getSingleCaseContactLanguagesRecord(
      id,
      res,
      req.headers[idirUsernameHeaderField] as string,
    );
  ...
  @ApiOperation({
    description:
      'Create a contact language record related to the given case and contact id.',
  })
  @ApiCreatedResponse({
    content: {
      [CONTENT_TYPE]: {
  ...
  @ApiOperation({
    description:
      'Create a contact education record related to the given case and contact id.',
  })
  @ApiCreatedResponse({
    content: {
      [CONTENT_TYPE]: {
  ...
  async postSingleCaseContactEducationRecord(
    ...
    return await this.casesService.postSingleCaseContactEducationRecord(
      contactEducationDto,
      req.headers[idirUsernameHeaderField] as string,
      id,
    );
  ...
  @ApiOperation({
    description:
      'Find all Contact Legal Authority entries related to a given Case and contact entity by Case and contact id.',
  })
  @ApiQuery({ name: afterParamName, required: false })
  @ApiQuery({ name: recordCountNeededParamName, required: false })
  @ApiQuery({ name: pageSizeParamName, required: false })
  ...
  async getListCaseContactLegalAuthorityRecord(
    ...
    return await this.casesService.getListCaseContactLegalAuthorityRecord(
      id,
      res,
      req.headers[idirUsernameHeaderField] as string,
      filter,
  ...
  @ApiOperation({
    description: `Displays the single ${contactLegalAuthorityIdName} result if it is related to the given Case and contact id.`,
  })
